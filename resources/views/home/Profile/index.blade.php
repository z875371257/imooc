                    ...
                    <div class="formBox">
                        <div id="setting-profile" class="setting-wrap setting-profile">
                            <div class="edit-info" style="display: none;">
                                <form class="js-wapper-form" action="{{ url('/home/users/setprofile/').$details->home_user_id }}" method="post" onsubmit="return sumbit_sure()">
                                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                    {{ method_field('PUT') }}
                                    <div class="moco-form-group">
                                        <label for="" class="moco-control-label">昵称：</label>
                                        <div class="moco-control-input">
                                            <input type="text" name="nickname" id="nick"  autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="{{ $details->nickname  }}" placeholder="请输入昵称"/>
                                    ...
                                    <div class="moco-form-group">
                                        ...
                                        <div class="moco-control-input">
                                            <select class="moco-form-control rlf-select" name="job" hidefocus="true" id="job" data-validate="require-select">
                                                ...
                                                <option @if($details->positions == '1')  selected="selected" @endif value="1" >Web前端工程师</option>
                                                <option @if($details->positions == '2')  selected="selected" @endif value="2" >PHP工程师</option>
                                                <option @if($details->positions == '3')  selected="selected" @endif value="3" >Java工程师</option>
                                                <option @if($details->positions == '4')  selected="selected" @endif value="4" >Android工程师</option>
                                                <option @if($details->positions == '5')  selected="selected" @endif value="5" >iOS工程师</option>
                                    ...
                                    <div class="moco-form-group wlfg-wrap">
                                        ...
                                        <div class="moco-control-input rlf-group rlf-radio-group">
                                            <label><input type="radio" @if( $details->sex == '0' ) checked="checked" @endif  hidefocus="true" value="0"   name="sex">保密</label>
                                            <label><input type="radio" @if( $details->sex == '1' ) checked="checked" @endif  hidefocus="true" value="1" checked="checked" name="sex">男</label>
                                            <label><input type="radio" @if( $details->sex == '2' ) checked="checked" @endif  hidefocus="true" value="2"  name="sex">女</label>
                                            <div class="rlf-tip-wrap errorHint color-red"></div>
                                        </div>
                                    </div>
                                    <div class="moco-form-group wlfg-wrap">
                                        ...
                                        <div class="moco-control-input">
                                            <div class="pr">
                                                <textarea name="aboutme"  id="aboutme"  rows="5" class="noresize js-sign moco-form-control">{{ $details->signature }}</textarea>
...
{{--发送ajax 提交个人信息修改数据--}}
                            ...
                            <div class="info-wapper">
                                <div class="info-box clearfix">
                                    <label class="pull-left">昵称</label><div class="pull-left">{{ $details->nickname }}</div>
                                </div>
                                <div class="info-box clearfix">
                                    <label class="pull-left">职位</label><div class="pull-left">{{ getPos($details->positions) }}</div>
                                </div>
                                <div class="info-box clearfix">
                                ...
                                <div class="info-box clearfix">
                                    <label class="pull-left">性别</label><div class="pull-left">
                                        {{ getSex($details->sex) }}</div>
                                </div>
                                <div class="info-box clearfix">
                                    <label class="pull-left">个性签名</label><div class="pull-left">{{ $details->signature }}</div>
                                </div>
                                {{--个人信息列表页--}}
                            </div>
                        </div>
