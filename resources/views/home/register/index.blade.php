...
<head>
    <meta charset="utf-8">
    <title></title>
    <link rel="stylesheet" type="text/css" href="/form/css/public.css">
    <style>
        ...
        *:focus {outline: none;}
        ...
        .contact_form input:focus, .contact_form textarea:focus {
            background: #fff url(/form/images/red_asterisk.png) no-repeat;
...
<body>
<div class="contact">
    <form class="contact_form" action="{{ url('register') }}" method="post" name="contact_form">
        <ul>
            <li>
                <h2>欢迎注册</h2>
            ...
            <li>
                ...
                <input type="text"   name="username" placeholder="请输入正确的姓名" required />
                <span class="form_hint">正确格式为：6~18个字符，可使用字母、数字、下划线，需以字母开头</span>
            </li>
            <li>
                <label for="password">密码:</label>
                <input type="password" name="password" placeholder="请输入正确的密码" required />
                <span class="form_hint">正确格式为：6~18个字符，可使用字母、数字、需要以字母开头</span>
            </li>
            <li>
                <label for="password">确认密码:</label>
                <input type="password" name="password1" placeholder="请输入正确的密码" required />
                <span class="form_hint">温馨提示：请与之前的密码保持一致</span>
            </li>
            <li>
