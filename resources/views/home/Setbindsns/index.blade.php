            ...
            <div class="setting-left l">
                <div class="avator-wapper">
                    <div class="avator-mode">
                        <img class="avator-img" src="{{$users->profile}}" data-portrait="597b0ff300016efc06950694" width="92" height="92">
                ...
                <div class="line"></div>
                    <ul class="menu">
                        ...
                        <li><a href="/home/users/set" class="on">个人信息<span class="arr"></span></a></li>
                        <li><a href="/home/users/passedit" class="">修改密码<span class="arr"></span></a></li>
                    </ul>
            </div>
        </div>
...
{{--个人信息列表页--}}            <div class="common-title">
                                个人信息
                                <a href="javascript: void(0);" class="pull-right js-edit-info" id="edit" onclick="edit({{ session('users')->id }})">编辑</a>
                            </div>
                            <div class="line"></div>
