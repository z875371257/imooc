            ...
            <div class="setting-left l">
                <div class="avator-wapper">
                    <div class="avator-mode">
                        <img class="avator-img" src="{{session()->get('details')->profile}}" data-portrait="597b0ff300016efc06950694" width="92" height="92">
                ...
                <div class="list-wapper">
                    ...
                    <ul class="menu">
                        ...
                        <li><a href="/home/users/set" class="">个人信息<span class="arr"></span></a></li>
                        <li><a href="/home/users/passedit" class="on">修改密码<span class="arr"></span></a></li>
                    </ul>
                </div>
            </div>
                        ...
                        <div id="setting-profile" class="setting-wrap setting-profile">
                            ...
                            <div class="info-wapper">
                                ...
                                <div class="moco-form-group">
                                    ...
                                    <div class="moco-control-input">
                                        <input type="password" name="passwd" id="passwd"  autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="" placeholder="请输入昵称"/>
                                        <span id="text1"></span>
                                ...
                                <div class="moco-form-group">
                                    ...
                                    <div class="moco-control-input">
                                        <input type="password" name="repasswd" id="repasswd"  autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="" placeholder="请输入昵称"/>
                                        <span id="text2"></span>
                                        <div class="rlf-tip-wrap errorHint color-red"></div>
                                    </div>
                                </div>
                                <div class="moco-form-group">
                                    ...
                                    <div class="moco-control-input">
                                        <input type="password" name="password" id="password"  autocomplete="off"  data-validate="require-nick"  class="moco-form-control" value="" placeholder="请输入昵称"/>
                                        <span id="text3"></span>
                                        <div class="rlf-tip-wrap errorHint color-red"></div>
                                    </div>
                                </div>
