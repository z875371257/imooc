...
<div class="cart-header">
  ...
  <div class="cart-body" id="cartBody">
		...
		<div class="item-2 l">
			<span class="c-4d555d">订单:{{$oid}}</span>
		</div>
		...
		<div class="cart-body-bot js-cart-body-bot">
			<div class="clearfix cart-body-bot-box">
				...
				<div class="right">
					<ul class="clearfix">
					    <li class="li-2">
							<div class="topdiv">支付宝：</div>
							<div class="price price-red clearfix">
								<img src="/homes/images/zhifubao.png" alt="">
							</div>
						</li>
					    <li class="li-2">
							<div class="topdiv">微信支付：</div>
							<div class="price price-red clearfix">
								<img src="/homes/images/weixin.png" alt="">
							</div>
						</li>
						<li class="li-2">
							<div class="topdiv">实付金额：</div>
							<div class="price price-red clearfix">
								<em>￥</em>
						...
						<li class="li-3">
							<span class="btn js-go-confrim"><a href="/doPay/{{$oid}}">确认购买</span>
						</li>
					</ul>
				</div>
			</div>
