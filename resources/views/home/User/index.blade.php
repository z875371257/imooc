                        ...
                        @foreach($users as $k => $v)
                            <tr class="@if ($k % 2 == 1) even @else odd @endif">
                                ...
                                <td>
                                    ...
                                    <a href="javascript:void(0)" onclick="lookUser({{$v->id}})" class='btn btn-warning' id="del">查看</a>
                                </td>
...
//                        alert(id);
                            ...
                            $.post("{{url('home/user/')}}/"+id,{'uid':id, '_method':'GET','_token':'{{csrf_token()}}'},function(data){
