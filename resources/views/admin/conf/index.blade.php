...
@section('title', '网站配置列表页')

@section('content')
    <div class="mws-panel grid_8">

        <div class="mws-panel-header">
            <span><i class="icon-table"></i>网站配置信息列表页{{config('web.web_title')}}</span>
        </div>
        <!-- 表单提交后发生错误信息的显示 -->
            ...
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        ...
                        <th  role="columnheader" rowspan="1" colspan="1" style="width:420px;" aria-label="Engine version: activate to sort column ascending">
                            内容
                        </th>
                    ...
                    @foreach($res as $k=>$v)
                        <tr class=" ">
                            ...
                            <td class=" ">
                                <a href="/admin/conf/{{$v->id}}/edit/" class='btn btn-success'>修改</a>
