...
@section('content')
    <div class="mws-panel grid_8">
        ...
        <div class="mws-panel-body no-padding">
            <form action="/admin/conf" method='post' enctype='multipart/form-data' class="mws-form">
                <div class="mws-form-inline">
                    <div class="mws-form-row">
                        <label class="mws-form-label">标题:</label>
                        <div class="mws-form-item">
                            <input type="text" class="small" name='conf_title' value="{{old('username')}}">
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <label class="mws-form-label">名称:</label>
                        <div class="mws-form-item">
                            <input type="text" class="small" name='conf_name'>
                        </div>
                    </div>
                    <div class="mws-form-row">
                    ...
                    <div class="mws-form-row">
                        ...
                        <div class="mws-form-item">
                            <textarea class="conf_content"  name="conf_tips" style="width:450px;height:100px"></textarea>
                        </div>
                    </div>
