            ...
            <div role="grid" class="dataTables_wrapper" id="DataTables_Table_1_wrapper">
                ...
                <table class="mws-datatable-fn mws-table dataTable" id="DataTables_Table_1"
                    ...
                    <tr role="row">
                        ...
                        <th  role="columnheader" rowspan="1" colspan="1" style="width: 100px;" aria-label="Browser: activate to sort column ascending">
                            标题
                        </th>
                        <th  role="columnheader" rowspan="1" colspan="1" style="width: 150px;" aria-label="Platform(s): activate to sort column ascending">
                            地址
                        </th>
                        <th  role="columnheader" rowspan="1" colspan="1" style="width:150px;" aria-label="Engine version: activate to sort column ascending">
                            添加时间
                        </th>

                        <th  role="columnheader"  rowspan="1" colspan="1" style="width: 100px;" aria-label="CSS grade: activate to sort column ascending">
                            状态
                        </th>
                    ...
                    @foreach($res as $k=>$v)
                        <tr class=" ">
                            ...
                            <td class=" ">
                                <a href="link/{{$v->id}}/edit/" class='btn btn-success'>修改</a>
