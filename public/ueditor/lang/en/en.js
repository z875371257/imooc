...
UE.I18N['en'] = {
    ...
    'insertvideo':{
        ...
        'urlError':"The vedeo url format may be wrong!",
        'loading':" &nbsp;The vedeo is loading, please wait…",
        'clickToSelect':"Click to select",
        'goToSource':'Visit source vedeo ',
        'noVideo':" &nbsp; &nbsp;Sorry,can't find the vedeo,please try again!",
